...
List<RequestResponse> requestResponseFromJson(String str) =>
    List<RequestResponse>.from(
        json.decode(str).map((x) => RequestResponse.fromJson(x)));

String requestResponseToJson(List<RequestResponse> data) =>
